 ...
 * under the License.
 */
package org.wso2.carbon.connector.intergrationtest.common;
...
public class ConnectorIntegrationUtil {
	...
	public static int sendRequestToRetriveHeaders(String addUrl, String query) throws IOException,
	                                                                          JSONException {
	...
	public static JSONObject sendRequest(String addUrl, String query) throws IOException,
	                                                                 JSONException {
